...
# Heading
w2 = Label(root, justify=LEFT, text=" DISEASE PRIDICTION USING MACHINE LEARNING ", fg="black", bg="lemon chiffon")
w2.config(font=("lucida", 35))
w2.grid(row=1, column=0, columnspan=2, padx=100)
w2 = Label(root, justify=LEFT, text="A Project by shaik adbul shareef", fg="white", bg="black")
w2.config(font=("Aharoni", 35))
...
lrLb = Label(root, text=" DECISION TREE :- ", fg="white", bg="black")
lrLb.grid(row=15, column=0, pady=10,sticky=W)

destreeLb = Label(root, text=" RANDOM FOREST :- ", fg="white", bg="black")
destreeLb.grid(row=17, column=0, pady=10, sticky=W)

ranfLb = Label(root, text=" NAIVE BAYES :- ", fg="white", bg="black")
...
dst = Button(root, text="DecisionTree", command=DecisionTree,bg="Black",fg="Black")
dst.grid(row=8, column=3,padx=10)

rnf = Button(root, text="Randomforest", command=randomforest,bg="Black",fg="Black")
rnf.grid(row=9, column=3,padx=10)

lr = Button(root, text="NaiveBayes", command=NaiveBayes,bg="Black",fg="Black")
lr.grid(row=10, column=3,padx=10)

#textfileds
t1 = Text(root, height=1, width=40,bg="light blue",fg="black")
t1.grid(row=15, column=1, padx=15)

t2 = Text(root, height=1, width=40,bg="light blue",fg="black")
t2.grid(row=17, column=1 , padx=15)

t3 = Text(root, height=1, width=40,bg="light blue",fg="black")
t3.grid(row=19, column=1 , padx=15)
